...
```javascript
import cartesianPower from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-cartesian-power@v0.1.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-cartesian-power/actions/workflows/test.yml/badge.svg?branch=v0.1.3
[test-url]: https://github.com/stdlib-js/array-cartesian-power/actions/workflows/test.yml?query=branch:v0.1.3
